...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (bookRepository.count() == 0) {
            ...
            Book book7 = new Book("I was killed and reborned as the weakest hero with no abilities but an OP cheat code", "Kim Young Woo", "213098420348123481", "A thrilling isekai about the tale of a hero with no abilities but an OP cheat code", true);
            ...
            if (customerRepository.count() == 0) {
                ...
                Customer customer4 = new Customer("Daniel", "daniel@test.com", "456789", "pass012", new ArrayList<>(), new ArrayList<>());

                customer4.setCurrentlyBorrowedBooks(Arrays.asList(book5, book6));
                if (librarianRepository.count() == 0) {
                    ...
                    Visit visit1 = new Visit(customer4, librarian1, LocalDateTime.now(), new ArrayList<>(), customer4.getCurrentlyBorrowedBooks());
                    customer4.getVisitHistory().add(visit1);
